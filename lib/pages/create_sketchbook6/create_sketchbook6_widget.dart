...
import 'create_sketchbook6_model.dart';
export 'create_sketchbook6_model.dart';

class CreateSketchbook6Widget extends StatefulWidget {
  const CreateSketchbook6Widget({
    Key? key,
  ...
  @override
  _CreateSketchbook6WidgetState createState() =>
      _CreateSketchbook6WidgetState();
}

class _CreateSketchbook6WidgetState extends State<CreateSketchbook6Widget>
    with TickerProviderStateMixin {
  late CreateSketchbook6Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateSketchbook6Model());
