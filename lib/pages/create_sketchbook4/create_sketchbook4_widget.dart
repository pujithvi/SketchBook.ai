...
import 'create_sketchbook4_model.dart';
export 'create_sketchbook4_model.dart';

class CreateSketchbook4Widget extends StatefulWidget {
  const CreateSketchbook4Widget({
    Key? key,
  ...
  @override
  _CreateSketchbook4WidgetState createState() =>
      _CreateSketchbook4WidgetState();
}

class _CreateSketchbook4WidgetState extends State<CreateSketchbook4Widget>
    with TickerProviderStateMixin {
  late CreateSketchbook4Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateSketchbook4Model());
