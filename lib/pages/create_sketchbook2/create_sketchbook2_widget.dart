...
import 'create_sketchbook2_model.dart';
export 'create_sketchbook2_model.dart';

class CreateSketchbook2Widget extends StatefulWidget {
  const CreateSketchbook2Widget({
    Key? key,
  ...
  @override
  _CreateSketchbook2WidgetState createState() =>
      _CreateSketchbook2WidgetState();
}

class _CreateSketchbook2WidgetState extends State<CreateSketchbook2Widget>
    with TickerProviderStateMixin {
  late CreateSketchbook2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateSketchbook2Model());
