...
import 'create_sketchbook3_model.dart';
export 'create_sketchbook3_model.dart';

class CreateSketchbook3Widget extends StatefulWidget {
  const CreateSketchbook3Widget({
    Key? key,
  ...
  @override
  _CreateSketchbook3WidgetState createState() =>
      _CreateSketchbook3WidgetState();
}

class _CreateSketchbook3WidgetState extends State<CreateSketchbook3Widget>
    with TickerProviderStateMixin {
  late CreateSketchbook3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateSketchbook3Model());
